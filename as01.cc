...
int main(){
    ...
    //Calculo de todos fatoriais 0-20
    factorial[0] = factorial[1] = 1;
    for (long long int i=2; i<21; i++){
        factorial[i]=i*factorial[i-1];
    }
    
    //leitura das entradas e soma dos fatoriais
    while(cin >>a){
        cin >> b;
 ...
 /* 
    ...
    os fatoriais de uma vez, aproveitando o resultado do fatorial ja calculado de n-1 para 
    ...
    entrada possivel. O calculo dos fatoriais tem custo fixo, independente do numero de entradas
